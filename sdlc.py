...
Original file is located at
    https://colab.research.google.com/drive/1SU65DNXUylCEchbBZTOOoQCXPuZlhMPK
"""
...
def quiz_generator(concept):
    prompt = f"Generate quiz questions about {concept} with different question types (multiple choice, true/false, short answer)."
